                ...
                <TableCell style={{ paddingLeft: `${level * 1.5 + 1}rem` }}>
                    <Collapsible>
                        <div className="flex items-center gap-2">
                            ...
                            <div className="cursor-pointer flex-1" onClick={() => onEdit(task)}>
                                {task.parentTaskId && (
                                    <TooltipProvider>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <div className="cursor-pointer inline-block mr-2" onClick={(e) => { e.stopPropagation(); onEdit(tasks.find(t => t.id === task.parentTaskId) as Task)}}>
